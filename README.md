...
A stunning and minimalist full screen flip clock desktop application for macOS built with Electron. It provides a clean and realistic animated time display that covers your entire screen.
